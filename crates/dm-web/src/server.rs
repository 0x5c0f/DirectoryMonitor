...
use crate::auth::{auth_login_handler, auth_status_handler, auth_verify_handler, check_auth};
...
// ── Auth handlers moved to auth.rs ────────────────────────────────────────────

// ── Auth verify handler moved to auth.rs ──────────────────────────────────────
